...
Public Class rptRentedInvoice
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Rental_System.rptRentedInvoice.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRentedInvoice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRentedInvoice = New rptRentedInvoice()
        rpt.Site = Me.Site
        Return rpt
    End Function
