...
Public Class rptItemPerCategory
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Rental_System.rptItemPerCategory.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptItemPerCategory
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptItemPerCategory = New rptItemPerCategory()
        rpt.Site = Me.Site
        Return rpt
    End Function
