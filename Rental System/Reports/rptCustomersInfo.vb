...
Public Class rptCustomersInfo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Rental_System.rptCustomersInfo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptCustomersInfo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptCustomersInfo = New rptCustomersInfo()
        rpt.Site = Me.Site
        Return rpt
    End Function
