...
Public Class rptRentalsperDate
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Rental_System.rptRentalsperDate.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptRentalsperDate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptRentalsperDate = New rptRentalsperDate()
        rpt.Site = Me.Site
        Return rpt
    End Function
