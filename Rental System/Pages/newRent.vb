...
Public Class newRent
    ...
    Private Sub gvRentals_RowsRemoved(sender As Object, e As DataGridViewRowsRemovedEventArgs)
    ...
    Private Sub cbCustname_SelectedIndexChanged(sender As Object, e As EventArgs)

    End Sub

    Private Sub lblItemName_Click(sender As Object, e As EventArgs)
    ...
    Private Sub BunifuDataGridView1_CellClick_1(sender As Object, e As DataGridViewCellEventArgs)

    End Sub

    Private Sub cbCustname_SelectedIndexChanged_1(sender As Object, e As EventArgs)

    End Sub



    Private Sub txtQty_TextChanged_1(sender As Object, e As EventArgs)

    End Sub

    Private Sub gvRentals_RowsRemoved_1(sender As Object, e As DataGridViewRowsRemovedEventArgs)
    ...
    Private Sub cbCustname_SelectedIndexChanged_2(sender As Object, e As EventArgs) Handles cbCustname.SelectedIndexChanged
        If RentCon.State = ConnectionState.Closed Then
            RentCon.Open()
        End If
    ...
    Private Sub gvRentals_RowsRemoved_2(sender As Object, e As DataGridViewRowsRemovedEventArgs) Handles gvRentals.RowsRemoved
        Dim sum As Decimal
        For k = 0 To gvRentals.RowCount - 1
            sum += gvRentals.Rows(k).Cells(3).Value
        Next
    ...
    Private Sub gvRentals_RowsAdded_1(sender As Object, e As DataGridViewRowsAddedEventArgs) Handles gvRentals.RowsAdded
        Dim sum As Decimal
        For k = 0 To gvRentals.RowCount - 1
            sum += gvRentals.Rows(k).Cells(3).Value
        Next
