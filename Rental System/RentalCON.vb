...
Module RentalCON
    ...
    Public Function RentalConnetionSting() As SqlConnection
        Return New SqlConnection(My.Settings.RentalDBConnectionString1)
        '"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=K:\Daakye\Rental System\Rental System\RentalDB.mdf;Integrated Security=True;MultipleActiveResultSets=true"
